...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Kripto</b>Grafi</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>ENKRIPSI</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>DEKRIPSI</span></a></li>
