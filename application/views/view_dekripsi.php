...
<body class="hold-transition sidebar-mini" style="background-color: #34495E;">
<div class="wrapper">
  ...
  <aside style="background-color:#1B2631;" class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="enkripsi" style="color :white;"><i class="fa fa-circle-o text-blue"></i> <span><b>ENKRIPSI</b></span></a></li>
